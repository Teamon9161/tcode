 ...
 *
 * Electron starts a window drag when the element under the pointer *itself*
 * has `data-drag-region` — it does not look at ancestors. So the bar carries
 ...
 */
export const DRAG = { "data-drag-region": true } as const;
