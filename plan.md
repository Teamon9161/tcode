...
3. 特别高亮应该包括单词中间的空格,现在单词中间的空格还是正常diff颜色,感觉有点奇怪
4. suggest功能的prompt没有单独放prompts吗,还有就是你觉得这个prompt有什么要改进的点吗,我感觉要加一个预测的语言用用户prompt的语言.
5. transcript的展示和下面那个responding...什么的状态最好有一个空行,不然都挤在一起了
